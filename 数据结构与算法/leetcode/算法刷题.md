...
## 6.[Z 字形变换](https://leetcode-cn.com/problems/zigzag-conversion/):heavy_multiplication_x:
...
public static void main(String[] args) {
    ...
    public static String convert(String s, int numRows) {
        ...
        int lie = 0;
        char[] chars = s.toCharArray();
        String[][] strings = new String[numRows][s.length() / (numRows + max) * 2 + 1];
        for (int i = 0; i < chars.length; i++) {
            if (i % (numRows * 2 - 2) == 0) {
                lie = 0;
                strings[lie][index] = chars[i] + "";
                lie++;
            } else {
                if (index % 2 == 0) {
                    strings[lie][index] = chars[i] + "";
                    if (lie % numRows == (numRows - 1)) {
                        index++;
                    }
                    lie++;
                } else {
                    strings[max][index] = chars[i] + "";
                    max--;
                    if (max == 0) {
                        max = numRows - 2;
                        index++;
